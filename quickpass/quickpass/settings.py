"""
Django settings for quickpass project.
...
SECRET_KEY = 'django-insecure-hwk8%60&(aq@_(w#*$i^iqz)y$!q+_74t$s7wk&ba%a2nl*z0='
...
MIDDLEWARE = [
    ...
    'integer.middleware.AuthRequiredMiddleware',
]

ROOT_URLCONF = 'quickpass.urls'
...
WSGI_APPLICATION = 'quickpass.wsgi.application'
...
STATIC_URL = 'quickpass/static/'
STATICFILES_DIRS = [ os.path.join(BASE_DIR, "static"),]

# Configuración de media
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_URL = 'quickpass/media/'
